...
def about():
    showinfo("Securenotes", "Securenotes secure notes for secured conscious people made by dhruvik securites \nStable version:- 1.0.8 \nDate of production:-7/3/2021 \nPropriteray Software licensed dhruv!k\u00a9\n\nFor feature request mail:- dongadhruvik@gmail.com")
...
if __name__ == '__main__':
    ...
    b1 = ttk.Button(toolbar, text="B", width=2, command=about)
    b1.pack(side=LEFT, padx=0, pady=0)
    b2 = ttk.Button(toolbar, text="I", width=2, command=about)
    b2.pack(side=LEFT, padx=0, pady=0)
    b2 = ttk.Button(toolbar, text="U", width=2, command=about)
    b2.pack(side=LEFT, padx=0, pady=0)
    ...
    b3 = ttk.Button(toolbar2, text="Set Font", width=10, command=about)
    b3.pack(side=LEFT, padx=0, pady=0)
    toolbar2.pack(side=RIGHT,fill=X)
    #toolbarend
